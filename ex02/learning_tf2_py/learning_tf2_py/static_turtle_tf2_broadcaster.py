...
#Конструктор класса StaticFramePublisher инициализирует узел с именем static_turtle_tf2_broadcaster.  Затем создается StaticTransformBroadcaster, который при запуске отправит одно статическое преобразование.
